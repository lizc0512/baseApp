...
public class TokenUtils {
    public static String getDeviceInfor(Context context) {
        ...
        String longitude = SharedPreferencesUtils.getInstance().getStringData(SpConstants.UserModel.LONGITUDE, "");
        String latitude = SharedPreferencesUtils.getInstance().getStringData(SpConstants.UserModel.LATITUDE, "");
        try {
    ...
    public static String getUUID(Context context) {
        SharedPreferences shared = context.getSharedPreferences(SharedPreferencesUtils.FILE_NAME, 0);
